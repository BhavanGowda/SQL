...
-- Explanation :
-- Step1 : As its given to provide taxes based upon the max salary a company provide to it employee, we will have to find the max salaries for each company
-- Step2 : Once we have the max salary available, we can then compare the actual salary of employee's with the max and perform the execution to apply taxes

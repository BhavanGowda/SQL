...
-- Explanation : 
-- Step1 : As we have to find the capital or total gain/loss for a particular stock that means we need to group the data
-- Step2 : While we are groupin the data to find the total gain/loss we need to make sure selling price should be considered positive but buying price should
-- be negative

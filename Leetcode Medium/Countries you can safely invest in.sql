...
-- Explanation:
-- Step1 : We need both the caller_id and callee_id durations along with the country that they belong too
-- Step2 : Once we have the above result we can apply avg functions to calculate the subsequent averages
